...
# Build environment
grub_target_cc='gcc'
grub_target_cc_version='gcc (GCC) 10.1.0'
...
grub_target_cppflags=' -Wall -W  -DGRUB_MACHINE_EFI=1 -DGRUB_MACHINE=X86_64_EFI -m64 -nostdinc -isystem /usr/lib/gcc/x86_64-pc-linux-gnu/10.1.0/include -I$(top_srcdir)/include -I$(top_builddir)/include'
